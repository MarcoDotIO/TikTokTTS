...
case "${unameOut}" in
    Linux*)     curl -s -X POST 'https''://api16-normal-useast5.us.tiktokv.com/media/api/text/speech/invoke/?text_speaker=en_us_002&req_text='${STR} | jq .data.v_str | base64 -di | ffplay -autoexit -volume 10 -f mp3 -;;
